...
Yon can see below some predictions made by the final trained model on some test images. The following predicted labels have been made on some Test images (Images that have not been passed to the Neural Network in its training phase).
